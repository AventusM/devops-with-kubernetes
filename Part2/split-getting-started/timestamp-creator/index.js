...
const run = () => {
  setInterval(() => {
    ...
    // const separator = "\n" Removed in 2.6
    const appendedText = `${timeStamp}` // Separator removed in 2.6
    fs.writeFile(filePath, appendedText, (err) => { // Can also use appendFile to show history data. Changed to writeFile in exercise 2.6 to scroll less
      if(err){
