...
app.get("/", async (_req, res) => {
  ...
  const pingPongDataResponse = await axios.get("http://ping-pong-service.course-exercises:2347") // Should get the current value without increasing it
  ...
  res.send(`${renderedMessage} ${hashTimestamp} ${responseCounter}`)
})
